const tools = [
  ...
  { name: 'FlowPix AI', description: 'Queue prompts and automate bulk image generation with a steady 5-second cadence.', category: 'Extensions', icon: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><path d="M13 2 4 14h6l-1 8 9-12h-6z"/></svg>', color: '#7c3aed', status: 'Extension', href: 'tools/flowpix/' },
